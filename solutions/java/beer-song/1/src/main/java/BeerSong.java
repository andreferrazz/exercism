    ...
    StringBuilder verse(int verseNumber) {
        ...
        switch (verseNumber) {
            case 0:
                ...
                break;
            case 1:
                verse.append(String.format(VERSE_TEMPLATE, "1 bottle", "1 bottle", "no more bottles").replace("one", "it"));
                break;
            case 2:
                verse.append(String.format(VERSE_TEMPLATE, "2 bottles", "2 bottles", "1 bottle"));
                break;
            default:
                verse.append(String.format(VERSE_TEMPLATE, verseNumber + " bottles", verseNumber + " bottles", (verseNumber - 1) + " bottles"));
        }
        return verse;
    }
